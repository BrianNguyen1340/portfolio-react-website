    ...
    <footer className="footer">
      <div className="footer__container container">
        ...
        <div className="footer__social">
          <a href="https://www.facebook.com/" rel='noreferrer' className="home__socia-link" target="_blank">
              <i className="uil uil-facebook-f color-black"></i>
          </a>
          <a href="https://twitter.com/" rel='noreferrer' className="home__social-link" target="_blank">
              <i className="uil uil-twitter-alt color-black"></i>
          </a>
          <a href="https://github.com/" rel='noreferrer' className="home__social-link" target="_blank">
